...
from generate_expert_cheetah import generate_expert_trajectory, initialize_pool
import cv2
import random
import scipy.misc
import os
...
filename = args.env_name + '_model/zforce_cheetah_lr'+ str(args.lr) + '_aux_w_' + str(args.aux_weight_start) + '_kld_w_' + str(args.kld_weight_start) + '_' + str(random.randint(1,500))
