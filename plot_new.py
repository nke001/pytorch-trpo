...
if __name__== '__main__':
    ...
    filename = 'HalfCheetah-v2_0.1_chunk/zforce_reacher_model_base_10k__lr0.0001_fwd_nll_1.0_fwd_l2w_1.0_aux_w_0.0001_kld_w_0.1_157/log.txt'
    #filename = 'HalfCheetah-v2_0.1_chunk_more_eval/zforce_reacher_model_base_10k__lr0.0001_fwd_nll_1.0_fwd_l2w_1.0_aux_w_0.0005_kld_w_0.05_347/log.txt'
    ...
    #filename = 'HalfCheetah-v2_0.1_chunk_more_eval/zforce_reacher_model_base_10k__lr0.0001_fwd_nll_1.0_fwd_l2w_1.0_aux_w_0.0005_kld_w_0.05_228/log.txt'
    #filename = 'HalfCheetah-v2_0.1_chunk_more_eval/zforce_reacher_model_base_10k__lr0.0001_fwd_nll_1.0_fwd_l2w_1.0_aux_w_0.0_kld_w_0.2_297/log.txt'
    
    filename = 'HalfCheetah-v2_0.1_chunk/zforce_reacher_model_base_10k__lr0.0001_fwd_nll_1.0_fwd_l2w_1.0_aux_w_0.0_kld_w_0.1_41/log.txt'
    #filename = 'HalfCheetah-v2_0.1_chunk/zforce_reacher_model_base_10k__lr0.0001_fwd_nll_1.0_fwd_l2w_1.0_aux_w_0.0_kld_w_0.15_473/log.txt'
